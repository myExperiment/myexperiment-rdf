...
$entities = array(
	...
	'FileVersion' => array("table" => "blob_versions", "versioned_id" => "blob_id", "ontology_prefix" => "mecontrib", "xml_service" => "file", "homepage" => true, "url_subpath" => "file_versions"),
	...
	'PackSnapshot' => array("table" => "pack_versions", "db_entity" => "PackVersion", "versioned_id" => "pack_id", "ontology_prefix" => "mepack", "xml_service" => "pack", "homepage" => true, "aggregates_resources" => true, "url_subpath" => "pack_snapshots"),
...
$mappings = array(
	...
	'Friendship' => array('id'=>'url','user_id'=>'&User|mebase:has-requester','friend_id'=>'&User|mebase:has-accepter','created_at'=>'dcterms:created','accepted_at'=>'mebase:accepted-at'),
	...
	'Membership' => array('id'=>'url','requester'=>'@getRequester|mebase:has-requester','accepter'=>'@getAccepter|mebase:has-accepter','requested_at'=>'@getRequesterTime|dcterms:created','accepted_at'=>'@getAccepterTime|mebase:accepted-at'),
	'Message' => array('id'=>'url'),
	...
	'User' => array('id'=>'url','created_at'=>'dcterms:created','updated_at'=>'dcterms:modified','last_seen_at'=>'mebase:last-seen-at','activated_at'=>'mebase:activated-at','profile_email'=>'@-getMailtoProfile|foaf:mbox','email_sha1sum'=>'@-getMboxSHA1Sum|foaf:mbox_sha1sum','organisation'=>'mebase:organisation','field_or_industry'=>'mebase:field','occupations_or_roles'=>'mebase:occuptation','interests'=>'mebase:interests','contact_details'=>'mebase:contact-details','friendships'=>'@getFriendships|','memberships'=>'@getMemberships|','favourites'=>'@getFavourites|'),
