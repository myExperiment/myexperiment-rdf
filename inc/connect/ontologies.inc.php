...
if (!empty($onto_db['password'])) mysql_connect($onto_db['server'],$onto_db['user'],$onto_db['password']) or die("Could not connect to MySQL on {$onto_db['server']} as user {$onto_db['user']} WITH password.");
else mysql_connect($onto_db['server'],$onto_db['user']) or die("Could not connect to MySQL on {$onto_db['server']} as user {$onto_db['user']} WITHOUT password.");
