...
Object Reuse and Exchange Homepage">OAI-ORE</a>, that can be assembled to build a comprehensive specification for the myExperiment data model.  <a href="http://rdf.myexperiment.org/ontologies/specification">Auto-generated documentation is available</a> that describes the documents and classes defined within the ontology.</p>
  ...
  <p>All myExperiment's public RDF data can queried using the query language SPARQL at <a href="sparql">myExperiment's SPARQL Endpoint</a>.  An introduction to SPARQL with a guide to querying myExperiment RDF <a href="howtosparql">is available here</a>.  If you want to query myExperiment's RDF yourself, you can download <a href="myexp_data_and_ontologies.zip">a zip file</a> containing all the graphs loaded into the SPARQL endpoint.  Namely, <a href="myexperiment.rdf">a file containing all myExperiment's public RDF</a> and each of the myExperiment ontologies.</p>
